...
public class ElectComputer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elect_computer);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(get_position==2){
                    ...
                    pdf.fromAsset("ECS_2nd_year.pdf").load();
                    pdf.setFitsSystemWindows(true);
                }

                if(get_position==3){

                    pdf.fromAsset("ECS_3rd_year.pdf").load();
                    pdf.setFitsSystemWindows(true);
                }

                if(get_position==4){

                    pdf.fromAsset("ECS_4th_year.pdf").load();
                    pdf.setFitsSystemWindows(true);
                }
