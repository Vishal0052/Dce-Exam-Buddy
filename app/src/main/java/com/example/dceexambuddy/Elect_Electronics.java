...
public class Elect_Electronics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elect__electronics);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(get_position==2){
                    ...
                    pdf.fromAsset("EEE_second_year.pdf").load();
                    pdf.setFitsSystemWindows(true);
                }

                if(get_position==3){

                    pdf.fromAsset("EEE_third_year.pdf").load();
                    pdf.setFitsSystemWindows(true);
                }

                if(get_position==4){

                    pdf.fromAsset("EEE_fourth_year.pdf").load();
                    pdf.setFitsSystemWindows(true);
                }
